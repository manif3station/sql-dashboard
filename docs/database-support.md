...
The file references in this section are the original DD-core verification files
from which this extracted skill inherited its support report.

Skill-local extraction proof instead lives in:

- `t/01-asset-copy.t`
- `t/02-bookmark-structure.t`
- `t/03-page-playwright.t`
